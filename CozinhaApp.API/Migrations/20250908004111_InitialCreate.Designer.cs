...
namespace CozinhaApp.API.Migrations
{
    ...
    [Migration("20250908004111_InitialCreate")]
            ...
            modelBuilder.Entity("CozinhaApp.API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativa = true,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(670),
                        ...
                        new
                        {
                            Id = 2,
                            Ativa = true,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(1331),
                        ...
                        new
                        {
                            Id = 3,
                            Ativa = true,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(1334),
                        ...
                        new
                        {
                            Id = 4,
                            Ativa = true,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(1335),
            ...
            modelBuilder.Entity("CozinhaApp.API.Models.Prato", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoriaId = 1,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(5870),
                        ...
                        new
                        {
                            Id = 2,
                            CategoriaId = 2,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(7280),
                        ...
                        new
                        {
                            Id = 3,
                            CategoriaId = 3,
                            DataCriacao = new DateTime(2025, 9, 8, 0, 41, 10, 753, DateTimeKind.Utc).AddTicks(7284),
