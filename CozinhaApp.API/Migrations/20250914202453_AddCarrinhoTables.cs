...
{
    /// <inheritdoc />
    public partial class AddCarrinhoTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carrinhos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataAdicao = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItensCarrinho_Pratos_PratoId",
                        column: x => x.PratoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItensCarrinho_CarrinhoId_PratoId",
                table: "ItensCarrinho",
                columns: new[] { "CarrinhoId", "PratoId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItensCarrinho_DataAdicao",
                table: "ItensCarrinho",
                column: "DataAdicao");

            migrationBuilder.CreateIndex(
                name: "IX_ItensCarrinho_PratoId",
                table: "ItensCarrinho",
                column: "PratoId");
