...
public class CozinhaAppContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Categoria>().HasData(
            new Categoria { Id = 1, Nome = "Entradas", Descricao = "Aperitivos e entradas", Ativa = true },
            new Categoria { Id = 2, Nome = "Pratos Principais", Descricao = "Pratos principais e refeições completas", Ativa = true },
            new Categoria { Id = 3, Nome = "Sobremesas", Descricao = "Doces e sobremesas", Ativa = true },
            new Categoria { Id = 4, Nome = "Bebidas", Descricao = "Bebidas e drinks", Ativa = true }
        );
